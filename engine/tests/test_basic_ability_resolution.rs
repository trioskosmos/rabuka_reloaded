...
// 
// Component-level testing of AbilityResolver is slop - it tests implementation details
// rather than gameplay behavior. The engine should be tested by playing the game.
