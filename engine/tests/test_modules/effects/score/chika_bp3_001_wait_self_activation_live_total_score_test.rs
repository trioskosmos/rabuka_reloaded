...
#[test]
fn chika_bp3_001_q152_self_only() {
...
#[test]
fn chika_bp3_001_q151_ability_lost_on_leave() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
...
#[test]
fn chika_bp3_001_q171_live_end_persistence() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
...
#[test]
fn chika_bp3_001_center_required() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
...
#[test]
fn chika_bp3_001_turn1_use_limit() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
...
#[test]
fn chika_bp3_001_wait_target_stays_on_stage() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
...
#[test]
fn chika_bp3_001_waited_member_activation_grants_live_total_plus1() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
...
#[test]
fn chika_bp3_001_wait_can_select_any_member() {
    let db = load_real_database();
    let mut game = TestGame::new(db);
