...
use std::sync::Arc;
    ...
    fn test_ruby_ability_working() {
        ...
        println!("✁ESetup complete - Ruby on stage, live cards in discard");
    ...
    fn create_ruby_ability() -> rabuka_engine::card::Ability {
        rabuka_engine::card::Ability {
            ...
            effect: Some(rabuka_engine::card::AbilityEffect {
    ...
    fn execute_cost_manually(game_state: &mut GameState, ability: &rabuka_engine::card::Ability) -> Result<(), String> {
    ...
    fn execute_effect_manually(game_state: &mut GameState, ability: &rabuka_engine::card::Ability) -> Result<(), String> {
