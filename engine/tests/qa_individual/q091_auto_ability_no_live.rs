...
fn test_q091_auto_ability_no_live() {
    ...
    let live_card = cards.iter()
        ...
        .expect("Required card PL!SP-pb1-001-R not found for Q091 test");
    ...
    assert!(!game_state.player1.live_card_zone.cards.contains(&live_id), "Live card should not be in live card zone");
