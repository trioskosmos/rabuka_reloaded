...
fn test_q092_auto_ability_cost_payment() {
    ...
    let live_card = cards.iter()
        ...
        .expect("Required card PL!SP-pb1-001-R not found for Q092 test");
    ...
    let active_energy_count = game_state.player1.energy_zone.cards.len();
    ...
    assert_eq!(game_state.player1.hand.cards.len(), initial_hand_size - 2, "Should have discarded 2 cards");
