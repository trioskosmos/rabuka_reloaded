...
fn test_q028_debut_without_baton_touch() {
    ...
    if let Some(member) = member_card {
        ...
        // The key assertion: can debut to area with member without baton touch by paying cost
        // This tests the debut without baton touch rule
        
        println!("Q028 verified: Can debut to area with member without baton touch by paying cost");
    } else {
        panic!("Required member card not found for Q028 test");
    }
}
