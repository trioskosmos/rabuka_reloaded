...
fn test_q156_multiple_cheer_retry() {
    ...
    // Question: If you're doing a live with 2 copies of "ダイスキだったらダイジョウブ！" and you use this ability on one copy, can you use the other copy's ability to perform cheer again?
    // Answer: Yes, you can.
    ...
    // Find the live card with this ability (PL!S-bp3-020-L "ダイスキだったらダイジョウブ！")
    ...
    if let Some(live) = live_card {
        ...
        assert_eq!(game_state.player1.live_card_zone.len(), 2, "Should have 2 live cards");
        
        // Simulate cheer: reveal cards, get blade hearts
        let revealed_cards = 3;
        ...
        game_state.player1.discard_zone.extend(vec![1, 2, 3]); // Simulate discarding revealed cards
