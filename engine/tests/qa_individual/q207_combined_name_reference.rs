...
#[test]
fn test_q207_combined_name_reference() {
    // Q207: If stage has "LL-bp1-001-R+" (combined name), how is it referenced?
    // Answer: As 1 member.
    ...
    if let Some(card) = combined_name_card {
        ...
        // The key point: combined name cards are referenced as 1 member
        // This test verifies that combined name cards count correctly
        println!("Combined name cards are referenced as 1 member");
    } else {
