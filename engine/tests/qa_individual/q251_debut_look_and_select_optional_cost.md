# Test Plan: Debut with Look-and-Select and Optional Cost

## 1. Test Objective
Test a debut ability with optional cost and look_and_select effect. This tests:
- Optional cost handling (手札を1枚控え室に置いてもよい)
- Look_and_select effect execution
- User choice for selecting cards from looked-at set
...
- **Why this card:** This card has a debut ability with optional cost followed by look_and_select. It tests the complete flow of optional cost payment, deck look, user selection, and card movement.

## 3. Initial Game State

**Player 1:**
- `hand`: [絢瀬 絵里, member_card_2, member_card_3]
