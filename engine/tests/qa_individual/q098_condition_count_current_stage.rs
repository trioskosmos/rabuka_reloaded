...
fn test_q098_condition_count_current_stage() {
    // Q98: Live start automatic ability - for each 5yncri5e! member on stage who debuted or moved area this turn, reduce need heart by 1
    // Question: At the time of resolving this ability, do 5yncri5e! members who are NOT on stage (but debuted or moved this turn) count?
    ...
    if let Some(live) = live_card {
        ...
        if let Some(member) = syncri5e_member {
            ...
            // Setup: Live card in live card zone, 5yncri5e! member debuted this turn but then left stage
        ...
        panic!("Required card PL!SP-pb1-025-L not found for Q098 test");
    }
}
