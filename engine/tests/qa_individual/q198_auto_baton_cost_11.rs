...
#[test]
fn test_q198_auto_baton_cost_11() {
    // Q198: If a member debuts via baton touch with cost 11, does this card's auto ability trigger?
    ...
    // Find a member card with auto ability
    ...
    if let Some(card) = auto_cost_card {
        ...
        // The key point: auto abilities don't trigger for baton touch debuts with cost 11
        // Similar to Q197, auto abilities have specific trigger conditions
        println!("Auto ability doesn't trigger for baton touch with cost 11");
    } else {
