// Auto-generated test stub for Q130
// Source: qa_data.json
// Question: 『 相手は手札からライブカードを1枚控え室に置いてもよい。そうしなかった場合、ライブ終了時まで、「 ライブの合計スコアを＋１する。」を得る。』について。 この能
// Answer: いいえ、ライブを行わない場合でもライブ勝敗判定フェイズの終了時に能力は消滅します。
// Related cards: "PL!S-pb1-002-R", "PL!S-pb1-002-P＋"
...
fn q130_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!S-pb1-002-R").expect("PL!S-pb1-002-R");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!S-pb1-002-P＋").expect("PL!S-pb1-002-P＋");
    ...
    println!("Q130 stub executed - manual completion required");
}
