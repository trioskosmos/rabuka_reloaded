// Auto-generated test stub for Q203
// Source: qa_data.json
// Question: 『虹ヶ咲』のカードの効果で自分のステージにいるウェイト状態のメンバーだけをアクティブにしていた場合、スコアは＋2されますか？
// Answer: いいえ。できません。
// Related cards: "PL!N-pb1-037-L"
...
fn q203_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-pb1-037-L").expect("PL!N-pb1-037-L");
    ...
    println!("Q203 stub executed - manual completion required");
}
