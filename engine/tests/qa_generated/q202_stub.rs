// Auto-generated test stub for Q202
// Source: qa_data.json
// Question: このカードの能力で「PL!N-PR-013-PR ミア・テイラー」を登場させたとき、そのカードの登場能力は使用できますか？
// Answer: はい。できます。
// Related cards: "PL!N-pb1-023-P＋", "PL!N-pb1-023-R"
...
fn q202_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-pb1-023-P＋").expect("PL!N-pb1-023-P＋");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-pb1-023-R").expect("PL!N-pb1-023-R");
    ...
    println!("Q202 stub executed - manual completion required");
}
