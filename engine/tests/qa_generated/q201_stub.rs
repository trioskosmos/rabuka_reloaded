// Auto-generated test stub for Q201
// Source: qa_data.json
// Question: このカードの能力で「PL!N-bp4-005-R、PL!N-bp4-005-P 宮下 愛」を登場させたとき、そのカードの登場能力は使用できますか？
// Answer: はい。できます。
// Related cards: "PL!N-pb1-017-P＋", "PL!N-pb1-017-R"
...
fn q201_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-pb1-017-P＋").expect("PL!N-pb1-017-P＋");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-pb1-017-R").expect("PL!N-pb1-017-R");
    ...
    println!("Q201 stub executed - manual completion required");
}
