// Auto-generated test stub for Q37
// Source: qa_data.json
// Question: や の自動能力は、同じタイミングで何回でも使えますか？
// Answer: いいえ、1回だけ使えます。 や になった時に1回だけ能力が発動するため、そのタイミングでは1回だけその能力を使うことができます。 複数の や の自動能力がある場
// Related cards: 
...
fn q37_stub() {
    ...
    println!("Q37 stub executed - manual completion required");
}
