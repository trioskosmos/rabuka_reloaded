// Auto-generated test stub for Q173
// Source: qa_data.json
// Question: 『 このターン、自分が余剰ハートに を1つ以上持っており、かつ自分のステージに『虹ヶ咲』のメンバーがいる場合、自分のエネルギーデッキから、エネルギーカードを1枚
// Answer: はい、可能です。
// Related cards: "PL!N-bp3-027-L"
...
fn q173_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-bp3-027-L").expect("PL!N-bp3-027-L");
    ...
    println!("Q173 stub executed - manual completion required");
}
