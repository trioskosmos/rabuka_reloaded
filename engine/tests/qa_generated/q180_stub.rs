// Auto-generated test stub for Q180
// Source: qa_data.json
// Question: 『 このターン、自分と相手のステージにいるメンバーは、効果によってはアクティブにならない。』について、この効果が発動したターンにアクティブフェイズを迎えました。
// Answer: はい、できます。
// Related cards: "PL!-pb1-009-R", "PL!-pb1-009-P＋"
...
fn q180_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!-pb1-009-R").expect("PL!-pb1-009-R");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!-pb1-009-P＋").expect("PL!-pb1-009-P＋");
    ...
    println!("Q180 stub executed - manual completion required");
}
