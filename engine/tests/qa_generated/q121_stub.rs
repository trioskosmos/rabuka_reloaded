// Auto-generated test stub for Q121
// Source: qa_data.json
// Question: 『 自分のライブカード置き場に「MY舞☆TONIGHT」以外の『Aqours』のライブカードがある場合、ライブ終了時まで、自分のステージのメンバーは を得る。』
// Answer: いいえ、自分のステージのメンバー全員が を得ます。
// Related cards: "PL!S-bp2-023-L"
...
fn q121_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!S-bp2-023-L").expect("PL!S-bp2-023-L");
    ...
    println!("Q121 stub executed - manual completion required");
}
