// Auto-generated test stub for Q4
// Source: qa_data.json
// Question: メインデッキを構築するとき、同じカードは何枚まで使用することができますか？
// Answer: カードナンバーが一致するカードを同じカードとして扱い、原則としてメインデッキに同じカードは4枚まで使用することができます。カードに記載されている「LL-bp1-
// Related cards: 
...
fn q4_stub() {
    ...
    println!("Q4 stub executed - manual completion required");
}
