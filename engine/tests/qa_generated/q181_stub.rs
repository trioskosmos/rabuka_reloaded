...
fn q181_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!-pb1-018-P＋").expect("PL!-pb1-018-P＋");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!-pb1-018-R").expect("PL!-pb1-018-R");
    ...
    println!("Q181 stub executed - manual completion required");
}
