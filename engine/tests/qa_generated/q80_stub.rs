// Auto-generated test stub for Q80
// Source: qa_data.json
// Question: 『 、このメンバーをステージから控え室に置く：自分の控え室からコスト15以下の「蓮ノ空」のメンバーカードを1枚、このメンバーがいたエリアに登場させる。』について
// Answer: いいえ、効果でメンバーカードが登場します。 起動能力のコストでこのメンバーカードがステージから控え室に置かれることにより、このエリアにはこのターンに登場したメン
// Related cards: "PL!HS-bp1-002-R", "PL!HS-bp1-002-P"
...
fn q80_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!HS-bp1-002-R").expect("PL!HS-bp1-002-R");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!HS-bp1-002-P").expect("PL!HS-bp1-002-P");
    ...
    println!("Q80 stub executed - manual completion required");
}
