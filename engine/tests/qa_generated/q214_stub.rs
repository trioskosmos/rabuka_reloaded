// Auto-generated test stub for Q214
// Source: qa_data.json
// Question: このカードの能力でスコアが0のライブカードを選んだ場合、支払うエネルギーはいくつですか？
// Answer: 0です。エネルギーを支払わずに選んだライブカードを手札に加えます。
// Related cards: "PL!N-bp5-003-R", "PL!N-bp5-003-P", "PL!N-bp5-003-AR"
...
fn q214_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-bp5-003-R").expect("PL!N-bp5-003-R");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-bp5-003-P").expect("PL!N-bp5-003-P");
    let card_2 = cards.iter().find(|c: &&Card| c.card_no == "PL!N-bp5-003-AR").expect("PL!N-bp5-003-AR");
    ...
    println!("Q214 stub executed - manual completion required");
}
