// Auto-generated test stub for Q144
// Source: qa_data.json
// Question: 『 手札を1枚控え室に置いてもよい：相手のステージにいるコスト4以下のメンバーを2人までウェイトにする。（ウェイト状態のメンバーが持つ は、エールで公開する枚数
// Answer: はい、可能です。 「～まで」の能力は指定された数字以内の数字を選択することができます。
// Related cards: "PL!-bp3-002-R", "PL!-bp3-002-P"
...
fn q144_stub() {
    ...
    let card_0 = cards.iter().find(|c: &&Card| c.card_no == "PL!-bp3-002-R").expect("PL!-bp3-002-R");
    let card_1 = cards.iter().find(|c: &&Card| c.card_no == "PL!-bp3-002-P").expect("PL!-bp3-002-P");
    ...
    println!("Q144 stub executed - manual completion required");
}
