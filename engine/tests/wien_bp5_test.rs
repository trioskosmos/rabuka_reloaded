...
fn wien_bp5_q223_p1_center_empty_opponent_chooses() {
    ...
    assert_eq!(game.state.player2.stage.stage[0], p2_center,
...
fn wien_bp5_q223_both_centers_occupied_both_choose() {
    ...
    assert_eq!(game.state.player1.stage.stage[2], p1_center,
        "P1 center moved to RightSide (swap)");
    assert_eq!(game.state.player1.stage.stage[1], p1_right,
        "p1_right swapped to Center");
    assert_eq!(game.state.player1.stage.stage[0], wien,
...
fn wien_bp5_q223_opponent_swap_when_destination_occupied() {
    ...
    assert_eq!(game.state.player2.stage.stage[1], p2_left,
