...
mod real_ability_test {
    ...
    #[test]
    fn test_ruby_ability_real_gameplay() {
        println!("=== RUBY ABILITY REAL GAMEPLAY TEST ===");
        
        // Create game with real players
        ...
        // Execute Ruby's ability manually step by step
        ...
        // Find first live card in discard (excluding Ruby)
        let live_card_to_move = game_state.player1.waitroom.cards.iter()
            .find(|id| {
                if **id == 1392 { return false; } // Skip Ruby
        ...
        if let Some(card_id) = live_card_to_move {
            ...
            println!("✁EEffect executed - Live card moved to hand");
        }
    ...
    #[test]
    fn test_draw_ability_real_gameplay() {
        println!("=== DRAW ABILITY REAL GAMEPLAY TEST ===");
    ...
    #[test]
    fn test_resource_gain_real_gameplay() {
        println!("=== RESOURCE GAIN REAL GAMEPLAY TEST ===");
