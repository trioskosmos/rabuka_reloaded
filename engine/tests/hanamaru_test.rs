...
fn hanamaru_q120_hand7_auto_condition_checked_after_blade_draws() {
    ...
    for _ in 0..100 { game.state.player1.main_deck.cards.push(live); }
    game.state.player2.main_deck.cards.clear();
    for _ in 0..100 { game.state.player2.main_deck.cards.push(filler); }

    for _ in 0..7 { game.state.player1.hand.cards.push(filler); }
...
fn hanamaru_q120_no_live_in_revealed_no_draw() {
    ...
    game.state.player1.main_deck.cards.clear();
    for _ in 0..100 { game.state.player1.main_deck.cards.push(filler); }
    game.state.player2.main_deck.cards.clear();
    for _ in 0..100 { game.state.player2.main_deck.cards.push(filler); }
