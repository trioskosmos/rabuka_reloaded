...
fn kinako_bp5_q234_deck_4_activation_succeeds_position_changes() {
    ...
    assert_eq!(game.state.player1.main_deck.cards.len(), 1,
    ...
    assert_eq!(game.state.player1.stage.stage[0], -1,
    ...
    assert_eq!(game.state.player1.stage.stage[1], center_member,
