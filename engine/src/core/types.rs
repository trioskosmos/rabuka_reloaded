...
impl ZoneId {
    pub fn from_str(s: &str) -> Self {
        match s {
            ...
            "deck_top_or_bottom" => ZoneId::DeckTopOrBottom,
            ...
            "looked_at_remaining" => ZoneId::LookedAtRemaining,
            "revealed_cards" => ZoneId::RevealedCards,
            "selected_cards" => ZoneId::SelectedCards,
            "those_cards" => ZoneId::ThoseCards,
            "preceding_moved" => ZoneId::PrecedingMoved,
            "recently_moved" => ZoneId::RecentlyMoved,
            "front" => ZoneId::Front,
            "live_total" => ZoneId::LiveTotal,
    ...
    pub fn from_ability_zone(z: crate::ability::enums::Zone) -> Self {
        match z {
            ...
            crate::ability::enums::Zone::DeckTop => ZoneId::DeckTop,
            crate::ability::enums::Zone::DeckBottom => ZoneId::DeckBottom,
            crate::ability::enums::Zone::DeckTopOrBottom => ZoneId::DeckTopOrBottom,
            crate::ability::enums::Zone::Front => ZoneId::Front,
            crate::ability::enums::Zone::LiveTotal => ZoneId::LiveTotal,
            crate::ability::enums::Zone::ThoseCards => ZoneId::ThoseCards,
            crate::ability::enums::Zone::PrecedingMoved => ZoneId::PrecedingMoved,
            crate::ability::enums::Zone::RecentlyMoved => ZoneId::RecentlyMoved,
            crate::ability::enums::Zone::LookedAtRemaining => ZoneId::LookedAtRemaining,
            crate::ability::enums::Zone::EmptyArea => ZoneId::EmptyArea,
            crate::ability::enums::Zone::SameArea => ZoneId::SameArea,
            crate::ability::enums::Zone::UnderMember => ZoneId::UnderMember,
            crate::ability::enums::Zone::LookedAt => ZoneId::LookedAt,
            _ => ZoneId::Unknown,
        }
    }
    pub fn to_ability_zone(self) -> Option<crate::ability::enums::Zone> {
        match self {
            ...
            ZoneId::DeckTop => Some(crate::ability::enums::Zone::DeckTop),
            ZoneId::DeckBottom => Some(crate::ability::enums::Zone::DeckBottom),
            ZoneId::DeckTopOrBottom => Some(crate::ability::enums::Zone::DeckTopOrBottom),
            ZoneId::Front => Some(crate::ability::enums::Zone::Front),
            ZoneId::LiveTotal => Some(crate::ability::enums::Zone::LiveTotal),
            ZoneId::ThoseCards => Some(crate::ability::enums::Zone::ThoseCards),
            ZoneId::PrecedingMoved => Some(crate::ability::enums::Zone::PrecedingMoved),
            ZoneId::RecentlyMoved => Some(crate::ability::enums::Zone::RecentlyMoved),
            ZoneId::LookedAtRemaining => Some(crate::ability::enums::Zone::LookedAtRemaining),
            ZoneId::EmptyArea => Some(crate::ability::enums::Zone::EmptyArea),
            ZoneId::SameArea => Some(crate::ability::enums::Zone::SameArea),
            ZoneId::UnderMember => Some(crate::ability::enums::Zone::UnderMember),
            ZoneId::LookedAt => Some(crate::ability::enums::Zone::LookedAt),
            _ => None,
        }
    }
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            ZoneId::DeckTopOrBottom => "deck_top_or_bottom",
            ...
            ZoneId::LookedAtRemaining => "looked_at_remaining",
            ZoneId::RevealedCards => "revealed_cards",
            ZoneId::SelectedCards => "selected_cards",
            ZoneId::ThoseCards => "those_cards",
            ZoneId::PrecedingMoved => "preceding_moved",
            ZoneId::RecentlyMoved => "recently_moved",
            ZoneId::Front => "front",
            ZoneId::LiveTotal => "live_total",
