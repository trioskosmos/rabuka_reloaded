@echo off
REM Build the Rabuka PS1 port and copy the PS-X EXE to platforms\ps1\output\.
REM
REM Requirements:
...
copy /y "C:\rust_targets\mipsel-sony-psx\release\rabuka_ps1.exe" "%~dp0output\rabuka.ps-exe" >nul
echo.
echo Built output\rabuka.ps-exe
echo Run it in DuckStation:
echo   "C:\Users\trios\AppData\Local\Programs\DuckStation\duckstation-qt-x64-ReleaseLTCG.exe" "%~dp0output\rabuka.ps-exe"
endlocal