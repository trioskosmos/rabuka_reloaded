            ...
            if ptr.is_null() {
                unsafe {
                    ...
                    _3ds_bot_queue_text(
                        ...
                        COL_MED,
                        SCALE_BODY,
                        format!("{}\0", tl("Camera init failed")).as_ptr(),
                    );
                    _3ds_bot_queue_text(40.0, 130.0, COL_MED, SCALE_SMALL, format!("{}\0", tl("B=back")).as_ptr());
                }
            ...
            if r > 0 {
                ...
                unsafe {
                    ...
                    _3ds_bot_queue_text(
                        ...
                        COL_MED,
                        SCALE_BODY,
                        format!("{}\0", tl_fmt("Camera error", &[("e", &r.to_string())])).as_ptr(),
                    );
                    _3ds_bot_queue_text(40.0, 130.0, COL_MED, SCALE_SMALL, format!("{}\0", tl("B=back")).as_ptr());
                }
                Step::Setup(cards.clone(), decks.clone(), SetupPhase::PickMode(2), true)
...
fn multiplayer_pc_host_wait(
    ...
    if was_dirty {
        ...
        unsafe {
            ...
            let ip = unsafe { std::ffi::CStr::from_ptr(_3ds_get_local_ip() as *const std::os::raw::c_char) }
                .to_string_lossy()
                .to_string();
            _3ds_bot_queue_text(
