...
#[cfg(feature = "3ds")]
use rabuka_3ds::lang::{current_lang, set_lang, tl, tl_fmt};
#[cfg(feature = "3ds")]
use rabuka_3ds::net::{execute_received_action, mp_can_act, route_authoritative_action};
#[cfg(feature = "3ds")]
use rabuka_3ds::setup::setup_step;
#[cfg(feature = "3ds")]
use rabuka_3ds::steps::{step_name, Overlay, SetupPhase, Step};
#[cfg(feature = "3ds")]
use rabuka_3ds::uds;
#[cfg(feature = "3ds")]
use rabuka_3ds::ui::colors::*;
#[cfg(feature = "3ds")]
use rabuka_3ds::ui::grid::{card_grid_input, render_card_detail, render_card_grid, GridAction};
#[cfg(feature = "3ds")]
use rabuka_3ds::ui::hint::render_hint_bar;
#[cfg(feature = "3ds")]
use rabuka_3ds::ui::text::*;
#[cfg(feature = "3ds")]
use rabuka_3ds::util::{cn_or_empty, heart_color_index, ticks_to_ms, tl_area, YieldReader};
                                    ...
                                    && !detail_mode
                                {
                                    ...
                                    while di < end && ty < 230.0 {
                                        ...
                                        if is_group {
                                            ...
                                            let hdr_prefix = "";
                                            for (_li, l) in wrap_text(&hdr, 370.0, line_scale)
                                                .lines()
                                                .enumerate()
                                            {
                                                if ty > 230.0 {
                                            ...
                                            let areas_prefix = "";
                                            for (_li, l) in wrap_text(&areas, 370.0, line_scale)
                                                .lines()
                                                .enumerate()
                                            {
                                                if ty > 230.0 {
