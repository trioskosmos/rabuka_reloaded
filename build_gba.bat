...
if not exist "%~dp0output_gba" mkdir "%~dp0output_gba"
agb-gbafix "C:\rust_targets\thumbv4t-none-eabi\release\rabuka_gba" -o "%~dp0output_gba\rabuka_gba.gba"
if errorlevel 1 (
    echo.
...
echo.
echo Built output_gba\rabuka_gba.gba