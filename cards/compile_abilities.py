...
def generate_abilities_gen(bytecode, offsets, strings, build_dir):
...
def main():
    ...
    bytecode, offsets, strings = compile_all(abilities)
    ...
    generate_abilities_gen(bytecode, offsets, strings, build_dir)
