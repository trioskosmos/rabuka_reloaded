/* @ts-self-types="./rabuka_wasm.d.ts" */
...
export class WasmGameEngine {
    ...
    execute_action(action) {
        const ret = wasm.wasmgameengine_execute_action(this.__wbg_ptr, action);
        if (ret[2]) {
     ...
     */
    get_frame_counter() {
        const ret = wasm.wasmgameengine_get_frame_counter(this.__wbg_ptr);
    ...
    get_game_result() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmgameengine_get_game_result(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get_legal_actions() {
        const ret = wasm.wasmgameengine_get_legal_actions(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {string}
    ...
    get_phase() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmgameengine_get_phase(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    /**
     * @param {bigint} _since_frame
     * @returns {any}
     */
    get_state_delta(_since_frame) {
        const ret = wasm.wasmgameengine_get_state_delta(this.__wbg_ptr, _since_frame);
        return ret;
    }
    /**
     * @param {any} config
     */
    constructor(config) {
        const ret = wasm.wasmgameengine_new(config);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    serialize() {
        const ret = wasm.wasmgameengine_serialize(this.__wbg_ptr);
 ...
 * @returns {number}
 */
export function wasm_rand_range(max) {
    const ret = wasm.wasm_rand_range(max);
    return ret >>> 0;
}
 ...
 */
export function wasm_shuffle(arr) {
    var ptr0 = passArray32ToWasm0(arr, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.wasm_shuffle(ptr0, len0, arr);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rabuka_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
