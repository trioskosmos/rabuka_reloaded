...
export const GameSetupModal = {
    openSetupModal: (mode) => {
        ...
        if (title) title.textContent = (mode === 'pvp') ? 'PvP Setup' : 'Sandbox Setup';
        ...
        if (p1Col) {
            if (mode === 'pvp') {
                ...
                if (p1Title) p1Title.textContent = (mode === 'sandbox') ? '[AI] Player 2 (AI)' : '[P2] Player 2 (Opponent)';
            }
        }
    },
