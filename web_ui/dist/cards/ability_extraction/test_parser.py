...
print(f"activation_condition_parsed: {result1.get('activation_condition_parsed', 'MISSING')}")
...
print(f"activation_condition_parsed: {result2.get('activation_condition_parsed', 'MISSING')}")
...
print(f"activation_condition_parsed: {result3.get('activation_condition_parsed', 'MISSING')}")
...
print(f"activation_condition_parsed: {result4.get('activation_condition_parsed', 'MISSING')}")
