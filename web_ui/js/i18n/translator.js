...
const UI_FALLBACKS = {
    ...
    'yes_label': 'Yes',
    'no_label': 'No',
    'draw_skip': 'Draw 0 (Skip)',
    'draw_count': 'Draw {count}',
    'move_to_top': 'Move card {n} to top',
    'apply_replacement': 'Apply replacement',
    ...
    'select_deck': 'Select Your Deck',
    'submit_join': 'Submit Deck & Join',
    'vs_ai_setup': 'VS AI Setup',
    'player2_ai': 'Player 2 (AI)',
    'replay_pause': '|| Pause',
    'replay_play': '> Play',
    'error_setting_deck': 'Error setting deck',
    'no_player_data': 'No player data',
    'no_zone_data': 'No zone data',
    'fetching_conditions': 'Fetching conditions...',
    'error_prefix': 'Error',
    'waiting_for_state': 'Waiting for game state...',
    'card_hidden': 'Card is hidden',
    'no_abilities_activatable': 'No abilities can be activated',
    'no_playable_areas': 'No playable areas available',
};
